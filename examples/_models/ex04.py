...
class ExamplesFlextModelsEx04:
    ...
    class CreateUser(m.Command):
        ...
        query_type: Annotated[
            str,
            u.Field(description="Query type placeholder for create user operation"),
        ] = ""
        event_type: Annotated[
            str,
            u.Field(description="Event type placeholder for create user operation"),
    ...
    class GetUser(m.Query):
        ...
        command_type: Annotated[
            str,
            u.Field(description="Command type placeholder for get user operation"),
        ] = ""
        query_type: Annotated[
            str,
        ...
        event_type: Annotated[
            str,
            u.Field(description="Event type placeholder for get user operation"),
        ] = "ex04_get_user_event"
    ...
    class DeleteUser(m.Command):
        ...
        query_type: Annotated[
            str,
            u.Field(description="Query type placeholder for delete user operation"),
        ] = ""
        event_type: Annotated[
            str,
            u.Field(description="Event type placeholder for delete user operation"),
    ...
    class AutoCommand(m.Command):
        ...
        query_type: Annotated[
            str,
            u.Field(description="Query type placeholder for auto command"),
        ] = ""
        event_type: Annotated[
            str,
    ...
    class Ping(m.Command):
        ...
        query_type: Annotated[
            str,
            u.Field(description="Query type placeholder for ping operation"),
        ] = ""
        event_type: Annotated[
            str,
            u.Field(description="Event type placeholder for ping operation"),
        ] = "ex04_ping_event"
    ...
    class UserCreated(m.Event):
        command_type: Annotated[
            str,
            u.Field(description="Command type placeholder for user created event"),
        ] = ""
        query_type: Annotated[
            str,
    ...
    class NoSubscriberEvent(m.Event):
        ...
        query_type: Annotated[
            str,
            u.Field(description="Query type placeholder for no subscribers event"),
        ] = ""
        marker: Annotated[
            str,
            u.Field(
