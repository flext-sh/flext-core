...
def demonstrate_configuration_hierarchies() -> None:
    ...
    env_configs = {
        ...
        "staging": {
            "logging": {"level": "INFO"},
            "database": {"host": "internal.invalid", "pool_size": 10},
            "cache": {"host": "internal.invalid"},
        },
        "production": {
            "logging": {"level": "WARNING", "output": "file"},
            "database": {"host": "internal.invalid", "pool_size": 50},
            "cache": {"host": "internal.invalid", "cluster": True},
