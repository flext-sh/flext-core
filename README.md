...
::: flext_core options: members: false show_root_heading: false show_root_toc_entry:
...
- Public extensions exposed by this project: `FlextApi`, `FlextBase`, `FlextCli`,
  `FlextConfig`, `FlextConstants`, `FlextConstantsEnforcement` (+20 more).
