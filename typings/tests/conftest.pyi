...
class TestDataBuilder[T]:
    def with_field(self, name: str, value: object) -> TestDataBuilder[_T]: ...
    def with_id(self, id_value: str) -> TestDataBuilder[_T]: ...
    def with_status(self, status: FlextEntityStatus) -> TestDataBuilder[_T]: ...
    def build(self) -> dict[str, object]: ...
    def build_as(self, cls: type[_T]) -> _T: ...
...
_TInput = TypeVar("_TInput", default=object)
_TExpected = TypeVar("_TExpected", default=object)

@dataclass
class TestCase(Generic[_TInput, _TExpected]):
    id: str
    description: str
    input_data: _TInput
    expected_output: _TExpected | None
...
@pytest.fixture
def test_cases() -> list[TestCase[object, object]]: ...
def parametrize_test_cases(
    test_cases: list[TestCase[object, object]],
