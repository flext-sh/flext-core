...
class ITestFactory(Protocol[_T]):
    def create(self, **kwargs: object) -> _T: ...
    def create_many(self, count: int, **kwargs: object) -> list[_T]: ...
...
class FlextTestUtilities:
    ...
    @staticmethod
    def assert_result_success(result: FlextResult[object]) -> object: ...
    @staticmethod
    def assert_result_failure(result: FlextResult[object]) -> str: ...
    @staticmethod
    def create_test_data(
        *, size: int = 10, prefix: str = "test"
    ) -> list[dict[str, object]]: ...

class FlextTestFactory:
    def __init__(self, model_class: type[object]) -> None: ...
    def set_defaults(self, **defaults: object) -> FlextTestFactory: ...
    def create(self, **kwargs: object) -> object: ...
    def create_many(self, count: int, **kwargs: object) -> list[object]: ...
    def create_batch(self, specifications: list[dict[str, object]]) -> list[object]: ...
