...
class FlextDecoratorUtils:
    ...
    def preserve_metadata(
        original: Callable[_P, _R], wrapper: Callable[_P, _R]
    ) -> Callable[_P, _R]: ...
...
class FlextValidationDecorators(FlextAbstractValidationDecorator):
    ...
    def apply_decoration(self, func: Callable[_P, object]) -> Callable[_P, object]: ...
    @staticmethod
...
class FlextDecorators:
    ...
    @staticmethod
    def safe_result(func: Callable[_P, object]) -> Callable[_P, object]: ...
    @staticmethod
