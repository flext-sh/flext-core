...
FlextLogLevel = FlextCore.Constants.Config.LogLevel
...
class TestFlextContext:
    """Test FlextCore.Types.Logging.LogContext TypedDict."""
...
class TestFlextLogger:
    ...
    def test_logger_auto_configuration(self) -> None:
        ...
        # The new thin FlextCore.Logger auto-configures structlog on first use
        assert logger is not None

    def test_get_logger_creates_instance(self) -> None:
        """Test that FlextCore.Logger creates logger instances."""
    ...
    def test_get_logger_caches_instances(self) -> None:
        """Test that FlextCore.Logger creates new instances (no caching in new implementation)."""
        logger1 = FlextCore.Logger("cached_test")
        logger2 = FlextCore.Logger("cached_test")

        # The new thin FlextCore.Logger doesn't cache instances
        assert logger1 is not logger2

    def test_logger_methods_exist(self) -> None:
        """Test that logger has expected methods."""
        logger = FlextCore.Logger("method_test")
        ...
        # The new thin FlextCore.Logger doesn't have bind method
        # Context binding is handled through FlextCore.Context

    def test_get_base_logger(self) -> None:
        """Test getting base logger instance."""
        base_logger = FlextCore.Logger("base_test")
    ...
    def test_get_base_logger_with_level(self) -> None:
        ...
        base_logger = FlextCore.Logger("level_test")

        assert base_logger is not None

    def test_bind_context(self) -> None:
        """Test binding context to logger."""
        logger = FlextCore.Logger("bind_test")
    ...
    def test_backward_compatibility_function(self) -> None:
        ...
        logger = FlextCore.Logger("compat_test")
    ...
    def test_module_level_function(self) -> None:
        ...
        logger = FlextCore.Logger("module_test")
...
class TestFlextLoggerUsage:
    """Test actual usage of FlextCore.Logger."""

    def test_basic_logging(self) -> None:
        """Test basic logging functionality."""
        # Use FlextCore.Logger constructor directly, not FlextCore.Logger()
        logger = FlextCore.Logger("usage_test")
    ...
    def test_bound_logger_usage(self) -> None:
        ...
        logger = FlextCore.Logger("bound_test")
    ...
    def test_context_manager_style(self) -> None:
        ...
        logger = FlextCore.Logger("context_mgr_test")
    ...
    def test_performance_logging(self) -> None:
        ...
        perf_logger = FlextCore.Logger("performance_test")
...
class TestFlextLoggerIntegration:
    """Integration tests for FlextCore.Logger."""

    def test_logging_hierarchy(self) -> None:
        """Test hierarchical logging."""
        parent_logger = FlextCore.Logger("parent")
        child_logger = FlextCore.Logger("parent.child")
        grandchild_logger = FlextCore.Logger("parent.child.grandchild")
    ...
    def test_complex_logging_scenario(self) -> None:
        ...
        logger = FlextCore.Logger("complex_test")
    ...
    def test_error_logging_with_context(self) -> None:
        ...
        logger = FlextCore.Logger("error_test")
    ...
    def test_performance_logging_integration(self) -> None:
        ...
        logger = FlextCore.Logger("perf_integration_test")
