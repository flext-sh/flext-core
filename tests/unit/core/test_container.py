"""Tests for FlextContainer dependency injection system.

Unit tests validating type-safe service management, registration patterns,
factory creation, and container configuration.
"""
...
if TYPE_CHECKING:
    from flext_core.protocols import FlextServiceFactory
