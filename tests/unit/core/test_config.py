...
from flext_core.config import FlextCoreSettings, configure_settings, get_settings
...
class TestSettingsGlobalFunctions:
    ...
    def test_configure_settings_with_none(self) -> None:
        """Test configuring settings with None creates new default instance.

        Creates new instance when None is passed.
        """
...
class TestSettingsEnvironmentIntegration:
    ...
    def test_environment_prefix_loading(
        ...
        """Test loading settings from environment variables with FLEXT_ prefix.
