...
class TestFlextConfig:
    ...
    def test_create_complete_config_validation_failure(self) -> None:
        ...
        with patch(
            "flext_core._config_base._BaseConfigValidation.validate_config_value",
        ) as mock_validate:
    ...
    def test_create_complete_config_load_failure(self) -> None:
        ...
        # Mock safe_load_from_dict to fail
        with patch(
            "flext_core._config_base._BaseConfigOps.safe_load_from_dict",
        ) as mock_load:
    ...
    def test_create_complete_config_defaults_failure(self) -> None:
        ...
        # Mock apply_defaults to fail
        with patch(
            "flext_core._config_base._BaseConfigDefaults.apply_defaults",
        ) as mock_defaults:
    ...
    def test_create_complete_config_exception_handling(self) -> None:
        ...
        # Create config data that will cause an exception
        with patch(
            "flext_core._config_base._BaseConfigOps.safe_load_from_dict",
        ) as mock_load:
    ...
    def test_load_and_validate_from_file_none_value(self) -> None:
        ...
        with patch(
            "flext_core._config_base._BaseConfigOps.safe_load_json_file",
        ) as mock_load:
    ...
    def test_merge_and_validate_configs_merge_failure(self) -> None:
        ...
        with patch(
            "flext_core._config_base._BaseConfigDefaults.merge_configs",
        ) as mock_merge:
    ...
    def test_get_env_with_validation_env_failure(self) -> None:
        ...
        with patch(
            "flext_core._config_base._BaseConfigOps.safe_get_env_var",
        ) as mock_env:
