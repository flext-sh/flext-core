    ...
    def test_interface_segregation_principle(self) -> None:
        ...
        class CustomAuthorizer:
            ...
            def authorize_query(self, query: object) -> FlextResult[None]:
                if isinstance(query, dict) and query.get("admin_only"):
        ...
        admin_query = {"admin_only": True}
        auth_result = query_handler.authorize_query(admin_query)
