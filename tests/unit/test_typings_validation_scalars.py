...
class TestsFlextCoreTypingsValidationScalars:
    ...
    def test_batch_size_accepts_in_range(self, value: int) -> None:
        ...
        adapter: p.TypeAdapter[int] = m.TypeAdapter(t.BatchSize)
    ...
    def test_max_length_accepts_positive(self, value: int) -> None:
        ...
        adapter: p.TypeAdapter[int] = m.TypeAdapter(t.MaxLength)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_positive_float_accepts_positive(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.PositiveFloat)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_non_negative_float_accepts_zero_and_positive(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.NonNegativeFloat)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_positive_timeout_accepts_in_range(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.PositiveTimeout)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_backoff_multiplier_accepts_at_or_above_one(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.BackoffMultiplier)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_percentage_accepts_in_range(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.Percentage)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_decimal_fraction_accepts_in_range(self, value: float) -> None:
        ...
        adapter: p.TypeAdapter[float] = m.TypeAdapter(t.DecimalFraction)
        tm.that(adapter.validate_python(value), eq=value)
    ...
    def test_non_empty_string_aliases_accept_non_empty(
        ...
        adapter: p.TypeAdapter[str] = m.TypeAdapter(alias)
        tm.that(adapter.validate_python(value), eq=value)
