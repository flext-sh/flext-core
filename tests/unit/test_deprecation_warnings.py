...
class TestDeprecationWarnings:
    ...
    def test_normalize_to_container_scalar_passthrough(self) -> None:
        ...
        tm.that(u.normalize_to_container(math.pi), eq=math.pi)
        tm.that(u.normalize_to_container(True), eq=True)
    ...
    def test_normalize_to_metadata_returns_metadata_value(self) -> None:
        ...
        dict_meta = u.normalize_to_metadata({"k": "v"})
    ...
    def test_no_deprecation_on_strict_methods(self) -> None:
        ...
        with warnings.catch_warnings(record=True) as w:
            warnings.simplefilter("always")
            _ = u.normalize_to_container("test")
            _ = u.normalize_to_metadata("test")
