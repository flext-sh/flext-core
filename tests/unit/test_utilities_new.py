...
class TestFlextUtilitiesPerformance:
    ...
    def test_id_generation_performance(self, benchmark: object) -> None:
    ...
    def test_uuid_generation_performance(self, benchmark: object) -> None:
    ...
    def test_truncate_performance(self, benchmark: object) -> None:
...
class TestFlextUtilitiesAsync:
    ...
    async def test_concurrent_id_generation(
        ...
        results = await async_test_utils.run_concurrent_tasks(
            [generate_ids() for _ in range(10)], max_concurrent=5
        )
