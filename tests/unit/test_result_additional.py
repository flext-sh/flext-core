...
class TestResultAdditional:
    """Additional coverage tests for flext_core result flows."""

    def test_ok_accepts_none(self) -> None:
        """None is a valid success value when T includes None."""
        result = r[str | None].ok(None)
        assert result.success
        assert result.value is None

    def test_map_error_identity_and_transform(self) -> None:
    ...
    def test_create_from_callable_and_repr(self) -> None:
    ...
    def test_with_resource_cleanup_runs(self) -> None:
