"""Comprehensive tests for FlextValue domain value object base class.

This module provides complete test coverage for the FlextValue class,
...
class TestFlextValueObjectEquality:
    """Test FlextValue equality behavior."""
    ...
    def test_equality_with_different_value_object_types(self) -> None:
        ...
        class AnotherValueObject(FlextValue):
            amount: Decimal
            currency: str = "USD"
...
class TestFlextValueObjectHashing:
    """Test FlextValue hashing behavior."""
...
class TestFlextValueObjectStringRepresentation:
    """Test FlextValue string representation."""
...
class TestFlextValueObjectDomainValidation:
    """Test FlextValue domain validation integration."""
...
class TestFlextValueObjectPydanticIntegration:
    """Test FlextValue integration with Pydantic features."""
...
class TestFlextValueObjectEdgeCases:
    """Test FlextValue edge cases and boundary conditions."""
...
class TestFlextValueObjectInheritance:
    """Test FlextValue inheritance patterns."""

    def test_single_inheritance(self) -> None:
        """Test single inheritance from FlextValue."""
