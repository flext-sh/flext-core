...
This module provides tests to improve coverage for the domain pydantic_base module.
It includes tests for DomainEntity, DomainValueObject, DomainEvent, and Field.
"""
    ...
    def test_dict_conversion_with_complex_data(self) -> None:
        ...
        class ComplexEntity(DomainEntity):
            ...
            def __init__(self, **data: object) -> None:
                ...
                super().__init__()
                self.complex_data: dict[str, object] = {
                    "nested": {"deep": "value"},
                    "list": [1, 2, 3],
