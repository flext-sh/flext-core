...
_LAZY_IMPORTS = merge_lazy_imports(
    ...
    ),
    {
        ...
        "FlextUnitTestProtocols": ("tests.unit.protocols", "FlextUnitTestProtocols"),
        ...
        "TestAliasContainsAny": (
            "tests.unit.test_beartype_engine",
            "TestAliasContainsAny",
        ),
        "TestAllLayerIntegration": (
            "tests.unit.test_enforcement",
            "TestAllLayerIntegration",
        ),
        "TestBaseModelCoverage": (
            "tests.unit.test_enforcement",
        ...
        "TestBeartypeConf": ("tests.unit.test_beartype_engine", "TestBeartypeConf"),
        "TestCaseMap": ("tests.unit._models_impl", "TestCaseMap"),
        "TestCheckExtraPolicy": ("tests.unit.test_enforcement", "TestCheckExtraPolicy"),
        "TestCheckFieldDescriptions": (
            "tests.unit.test_enforcement",
            "TestCheckFieldDescriptions",
        ),
        "TestCheckNoAny": ("tests.unit.test_enforcement", "TestCheckNoAny"),
        "TestCheckNoBareCollections": (
            "tests.unit.test_enforcement",
            "TestCheckNoBareCollections",
        ),
        ...
        "TestContainsAny": ("tests.unit.test_beartype_engine", "TestContainsAny"),
        ...
        "TestEnforcementMode": ("tests.unit.test_enforcement", "TestEnforcementMode"),
        ...
        "TestExemptions": ("tests.unit.test_enforcement", "TestExemptions"),
        "TestFacadeAccessibility": (
            "tests.unit.test_beartype_engine",
            "TestFacadeAccessibility",
        ),
        "TestFlextConstants": ("tests.unit.test_constants_new", "TestFlextConstants"),
        ...
        "TestFlextProtocols": ("tests.unit.test_protocols_new", "TestFlextProtocols"),
        ...
        "TestFlextTypes": ("tests.unit.test_typings_new", "TestFlextTypes"),
        ...
        "TestTypesEnforcement": ("tests.unit.test_enforcement", "TestTypesEnforcement"),
