...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "ANSI_RE": ("tests.unit.test_infra_output", "ANSI_RE"),
    ...
    "main": ("tests.unit.test_infra_github_main", "main"),
    ...
    "t": ("tests.unit.test_infra_patterns", "TestFlextInfraPatternsPatternTypes"),
    "test_accessor_take_pick_as_or_flat_and_agg_branches": (
        "tests.unit.test_utilities_mapper_full_coverage",
        "test_accessor_take_pick_as_or_flat_and_agg_branches",
    ),
