...
if TYPE_CHECKING:
    ...
    from ._result_scenarios import ResultOperationType, ResultScenario
    ...
    from .test_config_user_preferences import TestPackagedConfigWithUserPreferences
    ...
    from .test_decorators_full_coverage import TestsFlextCoreDecorators
    ...
    from .test_loggings_full_coverage import TestsFlextLoggings
    ...
    from .test_result_factory_dip import TestsFlextCoreResultFactoryDip, _ForeignResult
...
_LAZY_IMPORTS = MappingProxyType(
    build_lazy_import_map(
        MappingProxyType({
            "._beartype_engine_support": ("TestsFlextBeartypeEngine",),
            "._decorators_support": ("TestsFlextDecoratorsLegacy",),
            "._handlers_support": ("TestsFlextFlextHandlers",),
            "._models": ("_models",),
            "._result_exception_support": ("TestsFlextResultExceptionCarrying",),
            "._result_scenarios": ("ResultOperationType", "ResultScenario"),
            ...
            ".test_config_user_preferences": ("TestPackagedConfigWithUserPreferences",),
