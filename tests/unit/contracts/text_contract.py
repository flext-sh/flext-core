...
class TextUtilityContract:
    ...
    SAFE_STRING_VALID_CASES: ClassVar[list[tuple[str, str]]] = [
        ("hello", "hello"),
        ("  hello  ", "hello"),
        ("\nhello\t", "hello"),
        ("  olá mundo  ", "olá mundo"),
    ]
    SAFE_STRING_INVALID_CASES: ClassVar[list[tuple[str | None, str]]] = [
        (None, "Text cannot be None"),
        ("", "empty or whitespace-only"),
        ("   ", "empty or whitespace-only"),
        ("\n\t", "empty or whitespace-only"),
    ]
    FORMAT_APP_ID_CASES: ClassVar[list[tuple[str, str]]] = [
        ("MyApp", "myapp"),
        ("My App", "my-app"),
        ("my_app", "my-app"),
        ("My Application_Name", "my-application-name"),
    ]
    CLEAN_TEXT_CASES: ClassVar[list[tuple[str, str]]] = [
