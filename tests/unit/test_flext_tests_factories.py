...
class TestFlextTestsFactories:
    ...
    def test_factory_traits(self) -> None:
        ...
        if hasattr(FlextTestsFactories, "UserFactory"):
            if hasattr(FlextTestsFactories.UserFactory, "REDACTED_LDAP_BIND_PASSWORD_user"):
                REDACTED_LDAP_BIND_PASSWORD_user = FlextTestsFactories.UserFactory.REDACTED_LDAP_BIND_PASSWORD_user()
