...
class TestFlextTypes:
    ...
    def test_non_empty_str_valid(self) -> None:
        ...
        adapter: TypeAdapter[str] = TypeAdapter(t.NonEmptyStr)
    ...
    def test_bounded_str_valid(self) -> None:
        ...
        adapter: TypeAdapter[str] = TypeAdapter(t.BoundedStr)
    ...
    def test_positive_int_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.PositiveInt)
    ...
    def test_non_negative_int_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.NonNegativeInt)
    ...
    def test_port_number_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.PortNumber)
    ...
    def test_retry_count_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.RetryCount)
        tm.that(adapter.validate_python(0), eq=0)
    ...
    def test_worker_count_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.WorkerCount)
        tm.that(adapter.validate_python(1), eq=1)
        tm.that(adapter.validate_python(100), eq=100)
    ...
    def test_http_status_code_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.HttpStatusCode)
    ...
    def test_batch_size_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.BatchSize)
        tm.that(adapter.validate_python(1), eq=1)
    ...
    def test_max_length_valid(self) -> None:
        ...
        adapter: TypeAdapter[int] = TypeAdapter(t.MaxLength)
        tm.that(adapter.validate_python(1), eq=1)
    ...
    def test_positive_float_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.PositiveFloat)
    ...
    def test_non_negative_float_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.NonNegativeFloat)
    ...
    def test_positive_timeout_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.PositiveTimeout)
    ...
    def test_backoff_multiplier_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.BackoffMultiplier)
        tm.that(adapter.validate_python(1.0), eq=1.0)
    ...
    def test_percentage_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.Percentage)
        tm.that(adapter.validate_python(0.0), eq=0.0)
    ...
    def test_decimal_fraction_valid(self) -> None:
        ...
        adapter: TypeAdapter[float] = TypeAdapter(t.DecimalFraction)
        tm.that(adapter.validate_python(0.0), eq=0.0)
    ...
    def test_hostname_str_valid(self) -> None:
        ...
        adapter: TypeAdapter[str] = TypeAdapter(t.HostnameStr)
    ...
    def test_uri_string_valid(self) -> None:
        ...
        adapter: TypeAdapter[str] = TypeAdapter(t.UriString)
    ...
    def test_timestamp_str_valid(self) -> None:
        ...
        adapter: TypeAdapter[str] = TypeAdapter(t.TimestampStr)
