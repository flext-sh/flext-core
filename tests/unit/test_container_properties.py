...
class TestsFlextCoreContainerProperties:
    ...
    def test_resolve_type_mismatch_fails(
        self,
        container: FlextContainer,
    ) -> None:
    ...
    def test_drop_unknown_name_fails_not_found(
        self,
        container: FlextContainer,
    ) -> None:
    ...
    def test_drop_removes_registration(
        self,
        container: FlextContainer,
    ) -> None:
    ...
    def test_shared_returns_singleton_instance(
        self,
        container: FlextContainer,
    ) -> None:
