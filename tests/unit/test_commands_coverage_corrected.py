...
class TestFlextCommandsCorrected:
    ...
    def test_command_bus_private_methods_coverage(self) -> None:
        ...
        try:
            ...
            logging.getLogger(__name__).warning(f"Handler execute failed as expected: {e}")
        ...
        try:
            ...
            logging.getLogger(__name__).warning(f"Middleware application failed as expected: {e}")
