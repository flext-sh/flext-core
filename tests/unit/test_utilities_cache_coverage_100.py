...
class CacheScenarios:
    ...
    NORMALIZE_COMPONENT: ClassVar[list[NormalizeComponentScenario]] = [
        ...
        NormalizeComponentScenario(
            name="set_of_ints",
            component=cast("t.ContainerValue | BaseModel", {1, 2, 3}),
            expected_type=tuple,
        ),
        NormalizeComponentScenario(
            name="set_of_strings",
            component=cast("t.ContainerValue | BaseModel", {"a", "b", "c"}),
            expected_type=tuple,
        ),
        NormalizeComponentScenario(
            name="empty_set",
            component=cast("t.ContainerValue | BaseModel", set()),
            expected_type=tuple,
            expected_value=(),
        ),
        NormalizeComponentScenario(
...
class TestuCacheNormalizeComponent:
    ...
    def test_normalize_custom_object_fallback(self) -> None:
        ...
        obj = CustomObject()
        result = u.Cache.normalize_component(cast("t.ContainerValue | BaseModel", obj))
