...
class SampleDataFactories:
    ...
    @staticmethod
    def create_REDACTED_LDAP_BIND_PASSWORD_user() -> TestUserData:
        """Create REDACTED_LDAP_BIND_PASSWORD test user."""
        return TestUserData(
            user_id="REDACTED_LDAP_BIND_PASSWORD-123",
            name="Admin User",
            email="REDACTED_LDAP_BIND_PASSWORD@flext.example.com",
            roles=["REDACTED_LDAP_BIND_PASSWORD", "user", "tester"],
        )
