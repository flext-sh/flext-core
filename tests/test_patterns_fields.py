...
class TestFlextIntegerField:
    ...
    def test_integer_field_validate_value_with_validator(self) -> None:
        ...
        validator = FlextFieldValidator("test_field")
        field = FlextIntegerField(
            field_id="test_id",
            field_name="test_field",
            validator=validator,
...
class TestFlextFieldMetadata:
    ...
    def test_metadata_creation_with_values(self) -> None:
        ...
        assert internal.invalid is True
...
class ConcreteFlextField(FlextField[str]):
    ...
    def validate_value(self, value: object) -> FlextValidationResult:
        ...
        if self.required and value is None:
            ...
            result.add_field_error(self.field_name, "Field is required")
            return result
...
class TestFlextStringField:
    ...
    def test_string_field_validate_value_with_validator(self) -> None:
        """Test string field validation with custom validator."""
        validator = FlextFieldValidator("test_field")
        field = FlextStringField(
            field_id="test_id",
            field_name="test_field",
    ...
    def test_string_field_validate_non_string_type(self) -> None:
        ...
        assert not result.is_valid
        assert "Value must be a string" in result.field_errors["test_field"][0]
...
class TestFlextBooleanField:
    ...
    def test_boolean_field_validate_non_boolean_type(self) -> None:
        ...
        assert not result.is_valid
        error_msg = result.field_errors["test_field"][0]
        assert "Value must be a boolean" in error_msg
...
class TestFlextFieldRegistry:
    ...
    def test_validate_all_fields_required_missing(self) -> None:
        ...
        result = registry.validate_all_fields(data)
        assert not result.is_valid
        assert "Field is required" in result.field_errors["test_field"][0]
