...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestAuditorBrokenLinks": ("tests.infra.unit.docs.auditor_links", "TestAuditorBrokenLinks"),
    "TestAuditorCore": ("tests.infra.unit.docs.auditor", "TestAuditorCore"),
    "TestAuditorForbiddenTerms": ("tests.infra.unit.docs.auditor_scope", "TestAuditorForbiddenTerms"),
    ...
    "TestAuditorScopeFailure": ("tests.infra.unit.docs.auditor_cli", "TestAuditorScopeFailure"),
    "TestAuditorToMarkdown": ("tests.infra.unit.docs.auditor_links", "TestAuditorToMarkdown"),
    ...
    "TestFixerMaybeFixLink": ("tests.infra.unit.docs.fixer_internals", "TestFixerMaybeFixLink"),
    "TestFixerProcessFile": ("tests.infra.unit.docs.fixer_internals", "TestFixerProcessFile"),
    ...
    "TestFlextInfraDocScope": ("tests.infra.unit.docs.shared", "TestFlextInfraDocScope"),
    ...
    "TestGeneratorHelpers": ("tests.infra.unit.docs.generator_internals", "TestGeneratorHelpers"),
    "TestGeneratorScope": ("tests.infra.unit.docs.generator_internals", "TestGeneratorScope"),
    "TestIterMarkdownFiles": ("tests.infra.unit.docs.shared_iter", "TestIterMarkdownFiles"),
    "TestLoadAuditBudgets": ("tests.infra.unit.docs.auditor_budgets", "TestLoadAuditBudgets"),
    ...
    "TestMaybeWriteTodo": ("tests.infra.unit.docs.validator_internals", "TestMaybeWriteTodo"),
    ...
    "TestSelectedProjectNames": ("tests.infra.unit.docs.shared_iter", "TestSelectedProjectNames"),
    ...
    "TestValidateScope": ("tests.infra.unit.docs.validator_internals", "TestValidateScope"),
