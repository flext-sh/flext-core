...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "extract_dep_name": ("tests.infra.unit.deps.test_path_sync_init", "extract_dep_name"),
    "load_tool_config": ("tests.infra.unit.deps.test_modernizer_pytest", "load_tool_config"),
