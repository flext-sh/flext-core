...
class TestPhaseBuild:
    ...
    def test_report_dir_creation_fails(
        ...
        def _raise_mkdir(*a: t.ContainerValue, **kw: t.ContainerValue) -> None:
            del a, kw
