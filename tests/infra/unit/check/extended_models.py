...
class TestCheckIssueFormatted:
    ...
    def test_formatted_without_code(self) -> None:
        issue = CheckIssue(file="test.py", line=10, column=5, code="", message="Error")
        tm.that(issue.formatted, contains="test.py:10:5")
...
class TestProjectResultProperties:
    ...
    def test_total_errors_multiple_gates(self) -> None:
        ...
        issue1 = CheckIssue(file="a.py", line=1, column=1, code="E1", message="m1")
        issue2 = CheckIssue(file="b.py", line=2, column=1, code="E2", message="m2")
        issue3 = CheckIssue(file="c.py", line=3, column=1, code="E3", message="m3")
        exec1 = GateExecution(result=gate1, issues=[issue1, issue2])
        exec2 = GateExecution(result=gate2, issues=[issue3])
