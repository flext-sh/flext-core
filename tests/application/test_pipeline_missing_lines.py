...
class TestMissingExceptionHandlers:
    ...
    async def test_create_pipeline_runtime_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_create_pipeline_attribute_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_create_pipeline_connection_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_execute_pipeline_validation_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_get_pipeline_runtime_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_get_pipeline_connection_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
        """Test get_pipeline ConnectionError handling (line 167)."""
        # Make repository.get_by_id raise ConnectionError
        mock_repository.get_by_id.side_effect = ConnectionError("Connection failed in get")
    ...
    async def test_get_pipeline_general_exception(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_deactivate_pipeline_runtime_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
        """Test deactivate_pipeline RuntimeError handling (line 201, 207)."""
        # Setup pipeline first - need to mock get_by_id method
        pipeline = Pipeline(
            pipeline_name=PipelineName(value="test"),
    ...
    async def test_deactivate_pipeline_general_exception(self, service: PipelineService, mock_repository: AsyncMock) -> None:
...
class TestEdgeCaseExceptionPaths:
    ...
    async def test_create_pipeline_complex_exception_chain(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_execute_pipeline_nested_validation_error(self, service: PipelineService, mock_repository: AsyncMock) -> None:
    ...
    async def test_repository_state_consistency_during_exceptions(self, service: PipelineService, mock_repository: AsyncMock) -> None:
