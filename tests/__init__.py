...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestFacadeDeprecatedAliases": ("tests.unit.test_deprecation_warnings", "TestFacadeDeprecatedAliases"),
    ...
    "TestFlextInfraCommandRunnerExtra": ("tests.infra.unit.test_infra_subprocess_extra", "TestFlextInfraCommandRunnerExtra"),
    "TestFlextInfraConfigFixer": ("tests.infra.unit.check.pyrefly", "TestFlextInfraConfigFixer"),
    "TestFlextInfraConstantsAlias": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsAlias"),
    "TestFlextInfraConstantsCheckNamespace": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsCheckNamespace"),
    "TestFlextInfraConstantsConsistency": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsConsistency"),
    "TestFlextInfraConstantsEncodingNamespace": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsEncodingNamespace"),
    "TestFlextInfraConstantsExcludedNamespace": ("tests.infra.unit.test_infra_constants_core", "TestFlextInfraConstantsExcludedNamespace"),
    "TestFlextInfraConstantsFilesNamespace": ("tests.infra.unit.test_infra_constants_core", "TestFlextInfraConstantsFilesNamespace"),
    "TestFlextInfraConstantsGatesNamespace": ("tests.infra.unit.test_infra_constants_core", "TestFlextInfraConstantsGatesNamespace"),
    "TestFlextInfraConstantsGithubNamespace": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsGithubNamespace"),
    "TestFlextInfraConstantsImmutability": ("tests.infra.unit.test_infra_constants_extra", "TestFlextInfraConstantsImmutability"),
    "TestFlextInfraConstantsPathsNamespace": ("tests.infra.unit.test_infra_constants_core", "TestFlextInfraConstantsPathsNamespace"),
    "TestFlextInfraConstantsStatusNamespace": ("tests.infra.unit.test_infra_constants_core", "TestFlextInfraConstantsStatusNamespace"),
    ...
    "TestFlextInfraInitLazyLoading": ("tests.infra.unit.test_infra_init_lazy_core", "TestFlextInfraInitLazyLoading"),
    ...
    "TestFlextInfraPatternsEdgeCases": ("tests.infra.unit.test_infra_patterns_extra", "TestFlextInfraPatternsEdgeCases"),
    "TestFlextInfraPatternsMarkdown": ("tests.infra.unit.test_infra_patterns_core", "TestFlextInfraPatternsMarkdown"),
    "TestFlextInfraPatternsPatternTypes": ("tests.infra.unit.test_infra_patterns_extra", "TestFlextInfraPatternsPatternTypes"),
    "TestFlextInfraPatternsTooling": ("tests.infra.unit.test_infra_patterns_core", "TestFlextInfraPatternsTooling"),
    ...
    "TestFlextInfraReportingServiceCore": ("tests.infra.unit.test_infra_reporting_core", "TestFlextInfraReportingServiceCore"),
    "TestFlextInfraReportingServiceExtra": ("tests.infra.unit.test_infra_reporting_extra", "TestFlextInfraReportingServiceExtra"),
    ...
    "TestFlextInfraSubmoduleInitLazyLoading": ("tests.infra.unit.test_infra_init_lazy_submodules", "TestFlextInfraSubmoduleInitLazyLoading"),
    ...
    "TestGuardsDeprecatedMethods": ("tests.unit.test_deprecation_warnings", "TestGuardsDeprecatedMethods"),
    ...
    "TestMapperDeprecatedMethods": ("tests.unit.test_deprecation_warnings", "TestMapperDeprecatedMethods"),
    ...
    "TestOrchestratorFailures": ("tests.infra.unit.test_infra_workspace_orchestrator", "TestOrchestratorFailures"),
    ...
    "TestRuntimeDeprecatedNormalizeMethods": ("tests.unit.test_deprecation_warnings", "TestRuntimeDeprecatedNormalizeMethods"),
    ...
    "TestStrictContainerNormalization": ("tests.unit.test_deprecation_warnings", "TestStrictContainerNormalization"),
    ...
    "TestuTypeGuardsNormalizeToMetadata": ("tests.unit.test_utilities_type_guards_coverage_100", "TestuTypeGuardsNormalizeToMetadata"),
    ...
    "runtime_module": ("tests.unit.test_utilities_generators_full_coverage", "runtime_module"),
    ...
    "test_atomic_write_fail": ("tests.infra.unit.test_infra_workspace_sync", "test_atomic_write_fail"),
    "test_atomic_write_ok": ("tests.infra.unit.test_infra_workspace_sync", "test_atomic_write_ok"),
    ...
    "test_bump_version_invalid": ("tests.infra.unit.test_infra_versioning", "test_bump_version_invalid"),
    "test_bump_version_result_type": ("tests.infra.unit.test_infra_versioning", "test_bump_version_result_type"),
    "test_bump_version_valid": ("tests.infra.unit.test_infra_versioning", "test_bump_version_valid"),
    ...
    "test_capture_cases": ("tests.infra.unit.test_infra_subprocess_core", "test_capture_cases"),
    ...
    "test_cli_result_by_project_root": ("tests.infra.unit.test_infra_workspace_sync", "test_cli_result_by_project_root"),
    ...
    "test_current_workspace_version": ("tests.infra.unit.test_infra_versioning", "test_current_workspace_version"),
    ...
    "test_deprecated_normalize_to_general_value_warns": ("tests.unit.test_runtime_full_coverage", "test_deprecated_normalize_to_general_value_warns"),
    "test_deprecated_normalize_to_metadata_value_warns": ("tests.unit.test_runtime_full_coverage", "test_deprecated_normalize_to_metadata_value_warns"),
    ...
    "test_engine_constants_shared": ("tests.infra.unit.test_infra_templates", "test_engine_constants_shared"),
    ...
    "test_gitignore_entry_scenarios": ("tests.infra.unit.test_infra_workspace_sync", "test_gitignore_entry_scenarios"),
    "test_gitignore_sync_failure": ("tests.infra.unit.test_infra_workspace_sync", "test_gitignore_sync_failure"),
    "test_gitignore_write_failure": ("tests.infra.unit.test_infra_workspace_sync", "test_gitignore_write_failure"),
    ...
    "test_init_fallback_and_lazy_returns_result_property": ("tests.unit.test_result_full_coverage", "test_init_fallback_and_lazy_returns_result_property"),
    ...
    "test_is_container_negative_paths_and_callable": ("tests.unit.test_utilities_guards_full_coverage", "test_is_container_negative_paths_and_callable"),
    ...
    "test_is_general_value_list_accepts_list_subclass": ("tests.unit.test_utilities_collection_full_coverage", "test_is_general_value_list_accepts_list_subclass"),
    ...
    "test_lash_runtime_result_paths": ("tests.unit.test_result_full_coverage", "test_lash_runtime_result_paths"),
    ...
    "test_multiple_instances_independent": ("tests.infra.unit.test_infra_templates", "test_multiple_instances_independent"),
    ...
    "test_narrow_contextvar_exception_branch": ("tests.unit.test_context_full_coverage", "test_narrow_contextvar_exception_branch"),
    ...
    "test_parse_semver_invalid": ("tests.infra.unit.test_infra_versioning", "test_parse_semver_invalid"),
    "test_parse_semver_result_type": ("tests.infra.unit.test_infra_versioning", "test_parse_semver_result_type"),
    "test_parse_semver_valid": ("tests.infra.unit.test_infra_versioning", "test_parse_semver_valid"),
    ...
    "test_protocol_runtime_check": ("tests.unit.test_protocols_full_coverage", "test_protocol_runtime_check"),
    ...
    "test_release_tag_from_branch_invalid": ("tests.infra.unit.test_infra_versioning", "test_release_tag_from_branch_invalid"),
    "test_release_tag_from_branch_result_type": ("tests.infra.unit.test_infra_versioning", "test_release_tag_from_branch_result_type"),
    "test_release_tag_from_branch_valid": ("tests.infra.unit.test_infra_versioning", "test_release_tag_from_branch_valid"),
    ...
    "test_render_failure": ("tests.infra.unit.test_infra_templates", "test_render_failure"),
    "test_render_success": ("tests.infra.unit.test_infra_templates", "test_render_success"),
    "test_replace_project_version": ("tests.infra.unit.test_infra_versioning", "test_replace_project_version"),
    ...
    "test_run_raw_cases": ("tests.infra.unit.test_infra_subprocess_core", "test_run_raw_cases"),
    ...
    "test_sync_basemk_scenarios": ("tests.infra.unit.test_infra_workspace_sync", "test_sync_basemk_scenarios"),
    ...
    "test_sync_error_scenarios": ("tests.infra.unit.test_infra_workspace_sync", "test_sync_error_scenarios"),
    ...
    "test_sync_root_validation": ("tests.infra.unit.test_infra_workspace_sync", "test_sync_root_validation"),
    "test_sync_success_scenarios": ("tests.infra.unit.test_infra_workspace_sync", "test_sync_success_scenarios"),
    ...
    "test_template_constants": ("tests.infra.unit.test_infra_templates", "test_template_constants"),
    ...
    "test_type_guards_result": ("tests.unit.test_result_full_coverage", "test_type_guards_result"),
