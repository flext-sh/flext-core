...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "EngineSafetyStub": ("tests.infra.unit.refactor.test_infra_refactor", "EngineSafetyStub"),
    ...
    "TestDetectorBasicDetection": ("tests.infra.unit.test_infra_workspace_detector", "TestDetectorBasicDetection"),
    "TestDetectorGitRunScenarios": ("tests.infra.unit.test_infra_workspace_detector", "TestDetectorGitRunScenarios"),
    "TestDetectorRepoNameExtraction": ("tests.infra.unit.test_infra_workspace_detector", "TestDetectorRepoNameExtraction"),
    ...
    "TestDiscoverProjects": ("tests.infra.unit.test_infra_maintenance_python_version", "TestDiscoverProjects"),
    ...
    "TestEnforcerExecute": ("tests.infra.unit.test_infra_maintenance_python_version", "TestEnforcerExecute"),
    ...
    "TestEnsurePythonVersionFile": ("tests.infra.unit.test_infra_maintenance_python_version", "TestEnsurePythonVersionFile"),
    ...
    "TestFlextInfraCommandRunner": ("tests.infra.unit.test_infra_subprocess", "TestFlextInfraCommandRunner"),
    "TestFlextInfraConfigFixer": ("tests.infra.unit.check.pyrefly", "TestFlextInfraConfigFixer"),
    "TestFlextInfraConstantsAlias": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsAlias"),
    "TestFlextInfraConstantsCheckNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsCheckNamespace"),
    "TestFlextInfraConstantsConsistency": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsConsistency"),
    "TestFlextInfraConstantsEncodingNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsEncodingNamespace"),
    "TestFlextInfraConstantsExcludedNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsExcludedNamespace"),
    "TestFlextInfraConstantsFilesNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsFilesNamespace"),
    "TestFlextInfraConstantsGatesNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsGatesNamespace"),
    "TestFlextInfraConstantsGithubNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsGithubNamespace"),
    "TestFlextInfraConstantsImmutability": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsImmutability"),
    "TestFlextInfraConstantsPathsNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsPathsNamespace"),
    "TestFlextInfraConstantsStatusNamespace": ("tests.infra.unit.test_infra_constants", "TestFlextInfraConstantsStatusNamespace"),
    ...
    "TestFlextInfraGitService": ("tests.infra.unit.test_infra_git", "TestFlextInfraGitService"),
    "TestFlextInfraInitLazyLoading": ("tests.infra.unit.test_infra_init_lazy", "TestFlextInfraInitLazyLoading"),
    ...
    "TestFlextInfraMaintenance": ("tests.infra.unit.test_infra_maintenance_init", "TestFlextInfraMaintenance"),
    "TestFlextInfraNamespaceValidator": ("tests.unit.test_namespace_validator", "TestFlextInfraNamespaceValidator"),
    "TestFlextInfraPathResolver": ("tests.infra.unit.test_infra_paths", "TestFlextInfraPathResolver"),
    "TestFlextInfraPatternsEdgeCases": ("tests.infra.unit.test_infra_patterns", "TestFlextInfraPatternsEdgeCases"),
    "TestFlextInfraPatternsMarkdown": ("tests.infra.unit.test_infra_patterns", "TestFlextInfraPatternsMarkdown"),
    "TestFlextInfraPatternsPatternTypes": ("tests.infra.unit.test_infra_patterns", "TestFlextInfraPatternsPatternTypes"),
    "TestFlextInfraPatternsTooling": ("tests.infra.unit.test_infra_patterns", "TestFlextInfraPatternsTooling"),
    ...
    "TestFlextInfraProtocolsImport": ("tests.infra.unit.test_infra_protocols", "TestFlextInfraProtocolsImport"),
    "TestFlextInfraPyprojectModernizer": ("tests.infra.unit.deps.test_modernizer_main", "TestFlextInfraPyprojectModernizer"),
    "TestFlextInfraReportingService": ("tests.infra.unit.test_infra_reporting", "TestFlextInfraReportingService"),
    ...
    "TestFlextInfraSubmoduleInitLazyLoading": ("tests.infra.unit.test_infra_init_lazy", "TestFlextInfraSubmoduleInitLazyLoading"),
    "TestFlextInfraTomlDocument": ("tests.infra.unit.test_infra_toml_io", "TestFlextInfraTomlDocument"),
    "TestFlextInfraTomlHelpers": ("tests.infra.unit.test_infra_toml_io", "TestFlextInfraTomlHelpers"),
    "TestFlextInfraTomlRead": ("tests.infra.unit.test_infra_toml_io", "TestFlextInfraTomlRead"),
    "TestFlextInfraTypesImport": ("tests.infra.unit.test_infra_typings", "TestFlextInfraTypesImport"),
    "TestFlextInfraUtilitiesImport": ("tests.infra.unit.test_infra_utilities", "TestFlextInfraUtilitiesImport"),
    "TestFlextInfraUtilitiesSelection": ("tests.infra.unit.test_infra_selection", "TestFlextInfraUtilitiesSelection"),
    "TestFlextInfraVersion": ("tests.infra.unit.test_infra_version", "TestFlextInfraVersion"),
    ...
    "TestMaintenanceMainEnforcer": ("tests.infra.unit.test_infra_maintenance_main", "TestMaintenanceMainEnforcer"),
    "TestMaintenanceMainSuccess": ("tests.infra.unit.test_infra_maintenance_main", "TestMaintenanceMainSuccess"),
    ...
    "TestMigratorDryRun": ("tests.infra.unit.test_infra_workspace_migrator_pyproject", "TestMigratorDryRun"),
    "TestMigratorEdgeCases": ("tests.infra.unit.test_infra_workspace_migrator_internal", "TestMigratorEdgeCases"),
    "TestMigratorFlextCore": ("tests.infra.unit.test_infra_workspace_migrator_pyproject", "TestMigratorFlextCore"),
    "TestMigratorInternalMakefile": ("tests.infra.unit.test_infra_workspace_migrator_internal", "TestMigratorInternalMakefile"),
    "TestMigratorInternalPyproject": ("tests.infra.unit.test_infra_workspace_migrator_internal", "TestMigratorInternalPyproject"),
    "TestMigratorPoetryDeps": ("tests.infra.unit.test_infra_workspace_migrator_pyproject", "TestMigratorPoetryDeps"),
    "TestMigratorReadFailures": ("tests.infra.unit.test_infra_workspace_migrator_errors", "TestMigratorReadFailures"),
    "TestMigratorWriteFailures": ("tests.infra.unit.test_infra_workspace_migrator_errors", "TestMigratorWriteFailures"),
    ...
    "TestOrchestratorBasic": ("tests.infra.unit.test_infra_workspace_orchestrator", "TestOrchestratorBasic"),
    "TestOrchestratorRunProject": ("tests.infra.unit.test_infra_workspace_orchestrator", "TestOrchestratorRunProject"),
    "TestOrchestratorWithRunner": ("tests.infra.unit.test_infra_workspace_orchestrator", "TestOrchestratorWithRunner"),
    ...
    "TestReadRequiredMinor": ("tests.infra.unit.test_infra_maintenance_python_version", "TestReadRequiredMinor"),
    ...
    "TestReleaseTagFromBranch": ("tests.infra.unit.test_infra_versioning", "TestReleaseTagFromBranch"),
    "TestRemovedCompatibilityMethods": ("tests.infra.unit.test_infra_git", "TestRemovedCompatibilityMethods"),
    ...
    "TestRunOrchestrate": ("tests.infra.unit.test_infra_workspace_main", "TestRunOrchestrate"),
    ...
    "TestSyncFailures": ("tests.infra.unit.test_infra_workspace_sync", "TestSyncFailures"),
    "TestSyncGitignore": ("tests.infra.unit.test_infra_workspace_sync", "TestSyncGitignore"),
    "TestSyncInternals": ("tests.infra.unit.test_infra_workspace_sync", "TestSyncInternals"),
    ...
    "TestTemplateEngineConstants": ("tests.infra.unit.test_infra_templates", "TestTemplateEngineConstants"),
    "TestTemplateEngineErrorHandling": ("tests.infra.unit.test_infra_templates", "TestTemplateEngineErrorHandling"),
    "TestTemplateEngineInstances": ("tests.infra.unit.test_infra_templates", "TestTemplateEngineInstances"),
    "TestTemplateEngineRender": ("tests.infra.unit.test_infra_templates", "TestTemplateEngineRender"),
    ...
    "TestWorkspaceRoot": ("tests.infra.unit.test_infra_maintenance_python_version", "TestWorkspaceRoot"),
    ...
    "TestWorkspaceVersion": ("tests.infra.unit.test_infra_versioning", "TestWorkspaceVersion"),
    ...
    "infra_pr_workspace_manager": ("tests.unit.conftest_infra", "infra_pr_workspace_manager"),
    "infra_reporting": ("tests.unit.conftest_infra", "infra_reporting"),
    "infra_safe_command_output": ("tests.unit.conftest_infra", "infra_safe_command_output"),
    ...
    "orchestrator": ("tests.infra.unit.test_infra_workspace_orchestrator", "orchestrator"),
    ...
    "test_build_impact_map_extracts_rename_entries": ("tests.infra.unit.refactor.test_infra_refactor", "test_build_impact_map_extracts_rename_entries"),
    "test_build_impact_map_extracts_signature_entries": ("tests.infra.unit.refactor.test_infra_refactor", "test_build_impact_map_extracts_signature_entries"),
    ...
    "test_class_reconstructor_reorders_each_contiguous_method_block": ("tests.infra.unit.refactor.test_infra_refactor", "test_class_reconstructor_reorders_each_contiguous_method_block"),
    "test_class_reconstructor_reorders_methods_by_config": ("tests.infra.unit.refactor.test_infra_refactor", "test_class_reconstructor_reorders_methods_by_config"),
    "test_class_reconstructor_skips_interleaved_non_method_members": ("tests.infra.unit.refactor.test_infra_refactor", "test_class_reconstructor_skips_interleaved_non_method_members"),
    ...
    "test_engine_always_enables_class_nesting_file_rule": ("tests.infra.unit.refactor.test_infra_refactor", "test_engine_always_enables_class_nesting_file_rule"),
    ...
    "test_ensure_future_annotations_after_docstring": ("tests.infra.unit.refactor.test_infra_refactor", "test_ensure_future_annotations_after_docstring"),
    "test_ensure_future_annotations_moves_existing_import_to_top": ("tests.infra.unit.refactor.test_infra_refactor", "test_ensure_future_annotations_moves_existing_import_to_top"),
    ...
    "test_import_modernizer_adds_c_when_existing_c_is_aliased": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_adds_c_when_existing_c_is_aliased"),
    "test_import_modernizer_does_not_rewrite_function_parameter_shadow": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_does_not_rewrite_function_parameter_shadow"),
    "test_import_modernizer_does_not_rewrite_rebound_local_name_usage": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_does_not_rewrite_rebound_local_name_usage"),
    "test_import_modernizer_partial_import_keeps_unmapped_symbols": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_partial_import_keeps_unmapped_symbols"),
    "test_import_modernizer_partial_import_with_asname_keeps_unmapped_alias": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_partial_import_with_asname_keeps_unmapped_alias"),
    "test_import_modernizer_skips_rewrite_when_runtime_alias_shadowed_in_function": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_skips_rewrite_when_runtime_alias_shadowed_in_function"),
    "test_import_modernizer_skips_when_runtime_alias_name_is_blocked": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_skips_when_runtime_alias_name_is_blocked"),
    "test_import_modernizer_updates_aliased_symbol_usage": ("tests.infra.unit.refactor.test_infra_refactor", "test_import_modernizer_updates_aliased_symbol_usage"),
    ...
    "test_lazy_import_rule_hoists_import_to_module_level": ("tests.infra.unit.refactor.test_infra_refactor", "test_lazy_import_rule_hoists_import_to_module_level"),
    "test_lazy_import_rule_uses_fix_action_for_hoist": ("tests.infra.unit.refactor.test_infra_refactor", "test_lazy_import_rule_uses_fix_action_for_hoist"),
    "test_legacy_import_bypass_collapses_to_primary_import": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_import_bypass_collapses_to_primary_import"),
    "test_legacy_rule_uses_fix_action_remove_for_aliases": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_rule_uses_fix_action_remove_for_aliases"),
    "test_legacy_wrapper_forwarding_keywords_is_inlined_as_alias": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_wrapper_forwarding_keywords_is_inlined_as_alias"),
    "test_legacy_wrapper_forwarding_varargs_is_inlined_as_alias": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_wrapper_forwarding_varargs_is_inlined_as_alias"),
    "test_legacy_wrapper_function_is_inlined_as_alias": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_wrapper_function_is_inlined_as_alias"),
    "test_legacy_wrapper_non_passthrough_is_not_inlined": ("tests.infra.unit.refactor.test_infra_refactor", "test_legacy_wrapper_non_passthrough_is_not_inlined"),
    ...
    "test_main_all_groups_defined": ("tests.infra.unit.test_infra_main", "test_main_all_groups_defined"),
    "test_main_analyze_violations_is_read_only": ("tests.infra.unit.refactor.test_infra_refactor", "test_main_analyze_violations_is_read_only"),
    "test_main_analyze_violations_writes_json_report": ("tests.infra.unit.refactor.test_infra_refactor", "test_main_analyze_violations_writes_json_report"),
    ...
    "test_main_group_modules_are_valid": ("tests.infra.unit.test_infra_main", "test_main_group_modules_are_valid"),
    "test_main_help_flag_returns_zero": ("tests.infra.unit.test_infra_main", "test_main_help_flag_returns_zero"),
    ...
    "test_main_returns_error_when_no_args": ("tests.infra.unit.test_infra_main", "test_main_returns_error_when_no_args"),
    "test_main_unknown_group_returns_error": ("tests.infra.unit.test_infra_main", "test_main_unknown_group_returns_error"),
    ...
    "test_migrate_makefile_not_found_non_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_migrate_makefile_not_found_non_dry_run"),
    ...
    "test_migrate_pyproject_flext_core_non_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_migrate_pyproject_flext_core_non_dry_run"),
    ...
    "test_migrator_apply_updates_project_files": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_apply_updates_project_files"),
    "test_migrator_discovery_failure": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_discovery_failure"),
    "test_migrator_dry_run_reports_changes_without_writes": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_dry_run_reports_changes_without_writes"),
    "test_migrator_execute_returns_failure": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_execute_returns_failure"),
    "test_migrator_flext_core_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_flext_core_dry_run"),
    "test_migrator_flext_core_project_skipped": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_flext_core_project_skipped"),
    "test_migrator_gitignore_already_normalized_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_gitignore_already_normalized_dry_run"),
    "test_migrator_handles_missing_pyproject_gracefully": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_handles_missing_pyproject_gracefully"),
    "test_migrator_has_flext_core_dependency_in_poetry": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_migrator_has_flext_core_dependency_in_poetry"),
    "test_migrator_has_flext_core_dependency_poetry_deps_not_table": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_migrator_has_flext_core_dependency_poetry_deps_not_table"),
    "test_migrator_has_flext_core_dependency_poetry_table_missing": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_migrator_has_flext_core_dependency_poetry_table_missing"),
    "test_migrator_makefile_not_found_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_makefile_not_found_dry_run"),
    "test_migrator_makefile_read_failure": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_makefile_read_failure"),
    "test_migrator_no_changes_needed": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_no_changes_needed"),
    "test_migrator_preserves_custom_makefile_content": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_preserves_custom_makefile_content"),
    "test_migrator_pyproject_not_found_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_dryrun", "test_migrator_pyproject_not_found_dry_run"),
    "test_migrator_workspace_root_not_exists": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_workspace_root_not_exists"),
    "test_migrator_workspace_root_project_detection": ("tests.infra.unit.test_infra_workspace_migrator", "test_migrator_workspace_root_project_detection"),
    ...
    "test_mro_checker_keeps_external_attribute_base": ("tests.infra.unit.refactor.test_infra_refactor", "test_mro_checker_keeps_external_attribute_base"),
    "test_mro_redundancy_checker_removes_nested_attribute_inheritance": ("tests.infra.unit.refactor.test_infra_refactor", "test_mro_redundancy_checker_removes_nested_attribute_inheritance"),
    ...
    "test_pattern_rule_converts_dict_annotations_to_mapping": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_converts_dict_annotations_to_mapping"),
    "test_pattern_rule_keeps_dict_param_when_copy_used": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_keeps_dict_param_when_copy_used"),
    "test_pattern_rule_keeps_dict_param_when_subscript_mutated": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_keeps_dict_param_when_subscript_mutated"),
    "test_pattern_rule_keeps_type_cast_when_not_nested_object_cast": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_keeps_type_cast_when_not_nested_object_cast"),
    "test_pattern_rule_optionally_converts_return_annotations_to_mapping": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_optionally_converts_return_annotations_to_mapping"),
    "test_pattern_rule_removes_configured_redundant_casts": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_removes_configured_redundant_casts"),
    "test_pattern_rule_removes_nested_type_object_cast_chain": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_removes_nested_type_object_cast_chain"),
    "test_pattern_rule_skips_overload_signatures": ("tests.infra.unit.refactor.test_infra_refactor", "test_pattern_rule_skips_overload_signatures"),
    ...
    "test_refactor_files_skips_non_python_inputs": ("tests.infra.unit.refactor.test_infra_refactor", "test_refactor_files_skips_non_python_inputs"),
    "test_refactor_project_integrates_safety_manager": ("tests.infra.unit.refactor.test_infra_refactor", "test_refactor_project_integrates_safety_manager"),
    "test_refactor_project_scans_tests_and_scripts_dirs": ("tests.infra.unit.refactor.test_infra_refactor", "test_refactor_project_scans_tests_and_scripts_dirs"),
    ...
    "test_rule_dispatch_fails_on_invalid_pattern_rule_config": ("tests.infra.unit.refactor.test_infra_refactor", "test_rule_dispatch_fails_on_invalid_pattern_rule_config"),
    "test_rule_dispatch_fails_on_unknown_rule_mapping": ("tests.infra.unit.refactor.test_infra_refactor", "test_rule_dispatch_fails_on_unknown_rule_mapping"),
    "test_rule_dispatch_keeps_legacy_id_fallback_mapping": ("tests.infra.unit.refactor.test_infra_refactor", "test_rule_dispatch_keeps_legacy_id_fallback_mapping"),
    "test_rule_dispatch_prefers_fix_action_metadata": ("tests.infra.unit.refactor.test_infra_refactor", "test_rule_dispatch_prefers_fix_action_metadata"),
    ...
    "test_signature_propagation_removes_and_adds_keywords": ("tests.infra.unit.refactor.test_infra_refactor", "test_signature_propagation_removes_and_adds_keywords"),
    "test_signature_propagation_renames_call_keyword": ("tests.infra.unit.refactor.test_infra_refactor", "test_signature_propagation_renames_call_keyword"),
    ...
    "test_symbol_propagation_keeps_alias_reference_when_asname_used": ("tests.infra.unit.refactor.test_infra_refactor", "test_symbol_propagation_keeps_alias_reference_when_asname_used"),
    "test_symbol_propagation_renames_import_and_local_references": ("tests.infra.unit.refactor.test_infra_refactor", "test_symbol_propagation_renames_import_and_local_references"),
    "test_symbol_propagation_updates_mro_base_references": ("tests.infra.unit.refactor.test_infra_refactor", "test_symbol_propagation_updates_mro_base_references"),
    ...
    "test_violation_analysis_counts_massive_patterns": ("tests.infra.unit.refactor.test_infra_refactor", "test_violation_analysis_counts_massive_patterns"),
    "test_violation_analyzer_skips_non_utf8_files": ("tests.infra.unit.refactor.test_infra_refactor", "test_violation_analyzer_skips_non_utf8_files"),
    ...
    "test_workspace_cli_migrate_command": ("tests.infra.unit.test_infra_workspace_cli", "test_workspace_cli_migrate_command"),
    "test_workspace_cli_migrate_output_contains_summary": ("tests.infra.unit.test_infra_workspace_cli", "test_workspace_cli_migrate_output_contains_summary"),
    "test_workspace_migrator_error_handling_on_invalid_workspace": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_workspace_migrator_error_handling_on_invalid_workspace"),
    "test_workspace_migrator_makefile_not_found_dry_run": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_workspace_migrator_makefile_not_found_dry_run"),
    "test_workspace_migrator_makefile_read_error": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_workspace_migrator_makefile_read_error"),
    "test_workspace_migrator_pyproject_write_error": ("tests.infra.unit.test_infra_workspace_migrator_deps", "test_workspace_migrator_pyproject_write_error"),
