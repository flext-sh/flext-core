"""Tests for core type definitions - focused on essential usage
patterns."""

from __future__ import annotations

from flext_core import FlextConfigKey
from flext_core import FlextEntityId
from flext_core import FlextEventType
from flext_core import FlextPayload
from flext_core import FlextServiceName
...
class TestTypeAliases:
    ...
    def test_entity_id_basic_usage(self) -> None:
        ...
        user_id: FlextEntityId = FlextEntityId("user-123")
        order_id: FlextEntityId = FlextEntityId("order-456")
    ...
    def test_service_name_basic_usage(self) -> None:
        ...
        database_service: FlextServiceName = FlextServiceName("database")
        logger_service: FlextServiceName = FlextServiceName("logger")
    ...
    def test_config_key_basic_usage(self) -> None:
        ...
        db_host_key: FlextConfigKey = FlextConfigKey("database.host")
        api_key: FlextConfigKey = FlextConfigKey("api.key")
    ...
    def test_event_type_basic_usage(self) -> None:
        ...
        user_created: FlextEventType = FlextEventType("user.created")
        order_placed: FlextEventType = FlextEventType("order.placed")
