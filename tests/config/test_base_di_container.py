...
class TestDIContainerComprehensive:
    ...
    def test_factory_with_default_parameters(self) -> None:
        ...
        def factory_with_defaults(value: int = 42) -> str:  # Use int instead of str to avoid circular dependency
    ...
    def test_factory_configuration_error(self) -> None:
        ...
        def problematic_factory(required: dict) -> str:  # Use dict which is less likely to be registered
...
class TestDIContainerEdgeCases:
    ...
    def test_resolve_with_inspect_parameter_empty(self) -> None:
        ...
        class ClassWithEmptyAnnotation:
            def __init__(self, param="default") -> None:  # No type annotation but has default
                self.param = param
