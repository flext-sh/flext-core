...
if TYPE_CHECKING:
    ...
    from tests.integration.test_infra_integration import (
        ...
        TestExplicitReturnTypes,
        TestExplicitReturnTypes as t,
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestExplicitReturnTypes": ("tests.integration.test_infra_integration", "TestExplicitReturnTypes"),
    ...
    "t": ("tests.integration.test_infra_integration", "TestExplicitReturnTypes"),
