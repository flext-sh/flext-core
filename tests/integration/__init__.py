...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestServicerChaining": ("tests.integration.test_infra_integration", "TestServicerChaining"),
    ...
    "assert_result_success": ("tests.integration.patterns.test_patterns_logging", "assert_result_success"),
