...
@pytest.fixture
def large_dataset() -> list[FlextEntity]:
    """Fixture providing large dataset for performance testing."""
    return DomainEntityFactory.create_batch(size=1000)
...
@pytest.fixture
def entity_batch() -> list[FlextEntity]:
    """Fixture providing batch of entities."""
    return DomainEntityFactory.create_batch(size=50)
