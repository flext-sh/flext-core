...
class TestServiceResultInitialization:
    ...
    def test_service_result_init_with_custom_status(self) -> None:
        ...
        assert result.status == ResultStatus.PENDING  # Keeps custom status when success=True
...
class TestValidationFunctions:
    ...
    def test_validate_project_name_invalid_characters(self) -> None:
        ...
        assert "Project name must be alphanumeric with hyphens/underscores" in str(exc_info.value)
