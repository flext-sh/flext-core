...
1. **Dispatcher coverage**: The guide still references the old bus era in a few narrative sentences. Update wording to point to `FlextDispatcher` for CQRS orchestration and remove `FlextDispatcher` mentions entirely.
