...
1. **Alias clarity**: The convenience aliases exported by `flext_core` (`u, t, c, m, p, r, e, d, s, x, h`) are implied but not explicitly explained in the docs; add a compact cheat sheet to avoid confusion.
...
1. **Document alias usage**: Add a small cheat sheet showing the convenience import (`from flext_core import u, t, c, m, p, r, e, d, s, x, h`) and when to reach for each alias.
