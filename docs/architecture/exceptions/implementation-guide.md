...
class ApplicationExceptionHandler:
    ...
    def _handle_configuration_error(self, exception: FlextExceptions.ConfigurationError) -> dict:
        """Handle configuration errors with system REDACTED_LDAP_BIND_PASSWORDistrator guidance."""
        return {
            "error_type": "configuration_error",
            "message": "System configuration error - please contact REDACTED_LDAP_BIND_PASSWORDistrator",
