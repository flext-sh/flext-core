...
**algar-oud-mig**: OUD migration-specific configuration  
**gruponos-meltano-native**: GrupoNos-specific Meltano configuration
...
class AlgarOudMigConfig(FlextConfig):
    """Configuration for Algar OUD migration operations."""
