...
| 🟡 **High**     | flext-tap-ldif, algar-oud-mig             | 2     | 6-8            | **High**      |
    ...
    def process_data(self, entry: FlextProcessors.Entry) -> FlextResult[FlextTypes.Core.Dict]:
        ...
        try:
            ...
            migration_entry = {
                ...
                "processing_metadata": {
                    "processed_at": datetime.utcnow().isoformat(),
                    "processor_version": "algar-oud-mig-v2",
                    "migration_status": "ready"
                }
            }

            # Apply Algar-specific business rules
            business_result = self._apply_algar_business_rules(migration_entry)
...
| **algar-oud-mig**  | N/A             | <200ms/entry  | 1,000 entries  |
