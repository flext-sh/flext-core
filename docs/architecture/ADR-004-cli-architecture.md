...
| `client-a-oud-mig/cli.py`         | Project CLI          | Standalone implementation    |
...
│       │   └── system.py       # System/REDACTED_LDAP_BIND_PASSWORD commands
│       ├── plugins/
│       │   ├── __init__.py
...
flx auth login --username REDACTED_LDAP_BIND_PASSWORD
