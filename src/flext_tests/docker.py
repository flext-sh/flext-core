...
class FlextTestDocker:
    ...
    SHARED_CONTAINERS: ClassVar[Mapping[str, DockerContainerConfig]] = (
    ...
    def cleanup_volumes(
        ...
        Args:
            volume_pattern: Optional glob pattern to match volume names (e.g., 'client-a*')
    ...
    @property
    def shared_containers(self) -> Mapping[str, DockerContainerConfig]:
