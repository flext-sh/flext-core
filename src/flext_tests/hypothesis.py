...
class FlextTestsHypothesis:
    ...
    # Constants
    MIN_EMAIL_LENGTH = 5  # "a@b.c"
    MIN_URL_LENGTH = 7  # "http://"
        ...
        def phone_numbers() -> st.SearchStrategy[str]:
            ...
            return st.one_of(
                [
                    # +1-555-123-4567
                    st.builds(
                        FlextTestsHypothesis.FlextStrategies._format_phone_international,
                    ...
                    # (555) 123-4567
                    st.builds(
                        FlextTestsHypothesis.FlextStrategies._format_phone_parentheses,
                        area=st.integers(min_value=200, max_value=999).map(str),
                        exchange=st.integers(min_value=200, max_value=999).map(str),
                        number=st.integers(min_value=1000, max_value=9999).map(str),
                    ),
                    # 555.123.4567
                    st.builds(
                        FlextTestsHypothesis.FlextStrategies._format_phone_dotted,
                        area=st.integers(min_value=200, max_value=999).map(str),
                        exchange=st.integers(min_value=200, max_value=999).map(str),
                        number=st.integers(min_value=1000, max_value=9999).map(str),
                    ),
    ...
    class BusinessDomainStrategies:
        ...
        def user_names() -> st.SearchStrategy[str]:
            ...
            return st.builds(
                FlextTestsHypothesis.BusinessDomainStrategies._build_full_name,
        ...
        def company_names() -> st.SearchStrategy[str]:
            ...
            return st.builds(
                FlextTestsHypothesis.BusinessDomainStrategies._build_company_name,
    ...
    class PerformanceStrategies:
        ...
        def large_strings() -> st.SearchStrategy[str]:
            ...
            return st.builds(
                FlextTestsHypothesis.PerformanceStrategies._repeat_character,
        ...
        def nested_structures() -> st.SearchStrategy[Mapping[str, object]]:
            ...
            return st.recursive(
                ...
                FlextTestsHypothesis.PerformanceStrategies._build_nested_structure,
                max_leaves=50,
            )
    ...
    class PropertyTestHelpers:
        ...
        def assume_valid_email(email: str) -> bool:
            ...
            return (
                "@" in email
                and len(email) > FlextTestsHypothesis.MIN_EMAIL_LENGTH
        ...
        def generate_test_scenarios(
            ...
            return st.builds(
                _scenario_builder,
                data=strategy,
                id_val=FlextTestsHypothesis.FlextStrategies.flext_ids(),
            )
        ...
        def api_requests() -> st.SearchStrategy[FlextTypes.Core.Dict]:
            ...
            def _api_request(draw: st.DrawFn) -> FlextTypes.Core.Dict:
                return {
                    ...
                    "url": draw(FlextTestsHypothesis.FlextStrategies.urls()),
                    "headers": draw(
                        st.dictionaries(
                            st.sampled_from(
                                [
    ...
    @staticmethod
    def create_flext_strategy() -> FlextTestsHypothesis.FlextStrategies:
        """Create FlextStrategies instance."""
        return FlextTestsHypothesis.FlextStrategies()

    @staticmethod
    def create_business_strategy() -> FlextTestsHypothesis.BusinessDomainStrategies:
        """Create BusinessDomainStrategies instance."""
        return FlextTestsHypothesis.BusinessDomainStrategies()

    @staticmethod
    def create_edge_case_strategy() -> FlextTestsHypothesis.EdgeCaseStrategies:
        """Create EdgeCaseStrategies instance."""
        return FlextTestsHypothesis.EdgeCaseStrategies()

    @staticmethod
    def create_performance_strategy() -> FlextTestsHypothesis.PerformanceStrategies:
        """Create PerformanceStrategies instance."""
        return FlextTestsHypothesis.PerformanceStrategies()

    @staticmethod
    def create_helper() -> FlextTestsHypothesis.PropertyTestHelpers:
        """Create PropertyTestHelpers instance."""
        return FlextTestsHypothesis.PropertyTestHelpers()

    @staticmethod
    def create_composite_strategy() -> FlextTestsHypothesis.CompositeStrategies:
        """Create CompositeStrategies instance."""
        return FlextTestsHypothesis.CompositeStrategies()

    # === Quick Access Methods ===

    @staticmethod
    def quick_email() -> st.SearchStrategy[str]:
        """Quick access to email strategy."""
...
# Only FlextTestsHypothesis class is now exported

# Main class alias for backward compatibility - REMOVED
# FlextTestsHypotheses = FlextTestsHypothesis

# Legacy FlextStrategies class - REMOVED (commented out)
# class FlextStrategies:
#     """Compatibility facade for FlextStrategies - use FlextTestsHypothesis instead."""
#     ... all methods commented out

# Legacy BusinessDomainStrategies class - REMOVED (commented out)
# class BusinessDomainStrategies:
#     """Compatibility facade for BusinessDomainStrategies - use FlextTestsHypothesis instead."""
#     ... all methods commented out

# Legacy EdgeCaseStrategies class - REMOVED (commented out)
# class EdgeCaseStrategies:
#     """Compatibility facade for EdgeCaseStrategies - use FlextTestsHypothesis instead."""
#     ... all methods commented out

# Legacy PerformanceStrategies class - REMOVED (commented out)
# class PerformanceStrategies:
#     """Compatibility facade for PerformanceStrategies - use FlextTestsHypothesis instead."""
#     ... all methods commented out

# Legacy PropertyTestHelpers class - REMOVED (commented out)
# class PropertyTestHelpers:
#     """Compatibility facade for PropertyTestHelpers - use FlextTestsHypothesis instead."""
#     ... all methods commented out

# Legacy CompositeStrategies class - REMOVED (commented out)
# class CompositeStrategies:
#     """Compatibility facade for CompositeStrategies - use FlextTestsHypothesis instead."""
#     ... all methods commented out
