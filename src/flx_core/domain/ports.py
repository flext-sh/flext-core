...
if TYPE_CHECKING:
    from flx_core.advanced_types import (
        ConfigurationDict,
        MetadataDict,
        QueryParameters,
        ServiceResult,
    ...
    from flx_core.specifications import CompositeSpecification
    from flx_core.value_objects import ExecutionId, PipelineId, PluginId
