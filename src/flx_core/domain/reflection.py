...
from flx_core.domain.advanced_types import CompositeSpecification, NotSpecification

# ZERO TOLERANCE: Import protocols from canonical domain_patterns.py to eliminate duplicates
from flx_core.reflection.domain_patterns import (
    ConverterProtocol,
    DataclassProtocol,
    EntityBase,
    ValidatorProtocol,
...
class SpecificationBase:
    ...
    def __and__(self, other: SpecificationBase) -> AndSpecification:
        """Combine specifications with logical AND."""
        return AndSpecification(self, other)

    def __or__(self, other: SpecificationBase) -> OrSpecification:
