# FLX CORE PERSISTENCE - ENTERPRISE DATABASE INFRASTRUCTURE
...
The FLX Core Persistence module provides **enterprise-grade database infrastructure** with advanced async capabilities:
...
```
src/flx_core/infrastructure/persistence/
...
from flx_core.infrastructure.persistence.database import DatabaseManager, DatabaseConfig
...
PYTHONPATH=src python -c "
from flx_core.infrastructure.persistence.models import PipelineModel, PluginModel
