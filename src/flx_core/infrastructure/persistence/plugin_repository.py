...
from flx_core.infrastructure.persistence.models import PluginModel
...
class DatabasePluginRepository:
    ...
    async def install_plugin(
        self, plugin_data: PluginInstallRequest, installed_by: str
    ...
    async def get_plugin(
        self, plugin_name: str, user_id: str, user_role: str = "user"
        ...
        ----
            ...
            user_role: User role for access control (user/REDACTED_LDAP_BIND_PASSWORD)
