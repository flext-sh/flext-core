...
class ModernFlxApplication(Application):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize modern FLX application with dependency injection.
        ...
        self.logger.info(
            "Modern FLX application initialized",
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self._container.wire_dependencies(
                ...
                "flx_core.application.modern_application",
            )
...
def create_application(
    ...
    """Create a modern FLX application instance.
    ...
    logger.info(
        "Modern FLX application created",
        name=name,
