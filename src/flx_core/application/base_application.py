...
if TYPE_CHECKING:
    from flx_observability.monitoring.system_monitor import SystemMonitor
...
class BaseApplicationMixin(ABC):
    ...
    async def _setup_event_subscriptions(self) -> None:
        ...
        try:
            ...
            await event_bus.subscribe("application.startup", self._handle_startup_event)
            await event_bus.subscribe(
                "application.shutdown",
                self._handle_shutdown_event,
            )
            await event_bus.subscribe("application.error", self._handle_error_event)
    ...
    async def _handle_startup_event(self, event_data: dict) -> None:
    ...
    async def _handle_critical_health_event(self, event_data: dict) -> None:
        """Handle critical health event."""

    async def _handle_resource_exhausted_event(self, event_data: dict) -> None:
