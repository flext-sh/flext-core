...
class FlextLogger(FlextRuntime, p.Log.StructlogLogger):
    ...
    _scoped_contexts: ClassVar[dict[str, dict[str, t.MetadataValue]]] = {}
    _level_contexts: ClassVar[dict[str, dict[str, t.MetadataValue]]] = {}
    ...
    def logger(self) -> p.Log.StructlogLogger:
        ...
        if instance is None:
            instance = FlextRuntime.get_logger(getattr(self, "name", __name__))
    ...
    @classmethod
    def bind_context(cls, scope: str, **context: t.MetadataValue) -> r[bool]:
    ...
    @classmethod
    def bind_context_for_level(cls, level: str, **context: t.MetadataValue) -> r[bool]:
    ...
    @classmethod
    def bind_global_context(cls, **context: t.MetadataValue) -> r[bool]:
    ...
    @classmethod
    def for_container(
        cls, container: p.DI, level: str | None = None, **context: t.MetadataValue
    ) -> FlextLogger:
    ...
    @classmethod
    @contextmanager
    def scoped_context(cls, scope: str, **context: t.MetadataValue) -> Iterator[None]:
    ...
    @override
    def bind(self, **context: t.MetadataValue) -> Self:
    ...
    def build_exception_context(
        ...
        *,
        ...
        exc_info: bool,
        context: Mapping[str, object | Exception],
    ) -> m.ConfigMap:
    ...
    @override
    def new(self, **context: t.MetadataValue) -> Self:
    ...
    class ResultAdapter:
        ...
        def bind(self, **context: t.MetadataValue) -> FlextLogger.ResultAdapter:
