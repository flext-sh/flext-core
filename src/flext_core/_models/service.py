...
from flext_core import FlextModelsBase as m, FlextUtilitiesPydantic as up, p, t
...
class FlextModelsService:
    ...
    class DependencyContainerCreationOptions(m.ArbitraryTypesModel):
        ...
        wire_modules: Sequence[ModuleType] | None = up.Field(
            None,
            title="Wire Modules",
