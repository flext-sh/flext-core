...
class FlextUtilitiesContextTracing(FlextUtilitiesContextLifecycle):
    ...
    CORRELATION_ID: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
    ...
    PARENT_CORRELATION_ID: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
            c.ContextKey.PARENT_CORRELATION_ID,
            default=None,
        )
    )
    SERVICE_NAME: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
            c.ContextKey.SERVICE_NAME,
            default=None,
        )
    )
    SERVICE_VERSION: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
            c.ContextKey.SERVICE_VERSION,
            default=None,
        )
    )
    USER_ID: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
            c.ContextKey.USER_ID,
            default=None,
        )
    )
    REQUEST_ID: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
    ...
    REQUEST_TIMESTAMP: ClassVar[m.StructlogProxyContextVar[datetime]] = (
        FlextUtilitiesContext.create_datetime_proxy(
            c.ContextKey.REQUEST_TIMESTAMP,
            default=None,
        )
    )
    OPERATION_NAME: ClassVar[m.StructlogProxyContextVar[str]] = (
        FlextUtilitiesContext.create_str_proxy(
    ...
    OPERATION_METADATA: ClassVar[m.StructlogProxyContextVar[t.JsonMapping]] = (
        FlextUtilitiesContext.create_dict_proxy(
            c.ContextKey.OPERATION_METADATA,
            default=None,
        )
    )
