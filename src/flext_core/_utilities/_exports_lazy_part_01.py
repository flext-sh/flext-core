...
FLEXT_CORE__UTILITIES_LAZY_IMPORTS_PART_01 = build_lazy_import_map(
    {
        ...
        "._exports_lazy_part_01": ("FLEXT_CORE__UTILITIES_LAZY_IMPORTS_PART_01",),
        "._exports_lazy_part_02": ("FLEXT_CORE__UTILITIES_LAZY_IMPORTS_PART_02",),
        "._exports_lazy_part_03": ("FLEXT_CORE__UTILITIES_LAZY_IMPORTS_PART_03",),
...
__all__: list[str] = ["FLEXT_CORE__UTILITIES_LAZY_IMPORTS_PART_01"]
