...
if TYPE_CHECKING:
    ...
    from .enforcement import FlextUtilitiesEnforcement, PREDICATE_BINDINGS
    ...
    MappingProxyType(
        build_lazy_import_map(
            MappingProxyType({
                ...
                "._enforcement_parts.enforcement_part_06": (
                    "EXTENDED_PREDICATE_BINDINGS",
                ),
