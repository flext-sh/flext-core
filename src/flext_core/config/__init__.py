...
from flext_core.config.domain_config import (  # Unified Configuration Classes
    HTTP_BAD_REQUEST,
    HTTP_CREATED,
    HTTP_FORBIDDEN,
    HTTP_INTERNAL_ERROR,
...
# Use get_config() and FlextConfiguration directly
# Backward compatibility maintained only for essential interfaces
Settings = FlextConfiguration
UniversalFlxConfig = FlextConfiguration
