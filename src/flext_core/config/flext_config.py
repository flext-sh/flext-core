...
class _SettingsSingleton:
    ...
    def __init__(self) -> None:
        self._settings: FlextSettings | None = None

    def get_settings(self, *, reload: bool = False) -> FlextSettings:
        """Get FLEXT settings instance."""
        if self._settings is None or reload:
            self._settings = FlextSettings(
                project_name="flext",
...
def get_flext_settings(*, reload: bool = False) -> FlextSettings:
    ...
    """
    return _settings_singleton.get_settings(reload=reload)
