"""FLEXT Core Types - Centralized type definitions for the entire FLEXT ecosystem.
...
Usage:
    from flext_core.core_types import FlextTypes, T, TAnyDict
...
class FlextTypes:
    ...
    class Validation:
        ...
        type ValidationPipeline = list[FlextTypes.Validation.CustomValidator]  # Chain of validators
...
def get_centralized_types_usage_info() -> str:
    ...
    return (
        "All types are now centralized in core_types.py. "
        "Use 'from flext_core.core_types import FlextTypes' for new development. "
