    ...
    **ARCHITECTURAL ROLE**: Defines the validation contract that enables
    ...
    Usage Examples:
        ...
        Using with processors:
            ...
            >>> # validator = SimpleEntryValidator(whitelist={"REDACTED_LDAP_BIND_PASSWORD", "user", "guest"})  # doctest: +SKIP
        ...
        Example:
            Implementing comprehensive validation::
                ...
                def is_valid(self, entry: object) -> bool:
                    ...
                    if (
                        entry.entry_type == "REDACTED_LDAP_BIND_PASSWORD"
                        and not entry.clean_content.startswith("REDACTED_LDAP_BIND_PASSWORD_")
                    ):
                        return False
    ...
    **ARCHITECTURAL ROLE**: Serves as the abstract base for specialized processors
    ...
    Usage Examples:
        ...
        Using the processor with validation::
            ...
            validator = SimpleEntryValidator(whitelist={'REDACTED_LDAP_BIND_PASSWORD', 'user', 'guest'})

            # Create processor with validator
            processor = UserEntryProcessor(validator=validator)

            # Process entry content
            content = \"username: REDACTED_LDAP_BIND_PASSWORD, email: REDACTED_LDAP_BIND_PASSWORD@example.com, roles: [REDACTED_LDAP_BIND_PASSWORDistrator]\"
    ...
    def __init__(self, validator: FlextEntryValidator | None = None) -> None:
        ...
        Example:
            ...
            With custom validator::
                ...
                validator = CustomValidator(whitelist=["REDACTED_LDAP_BIND_PASSWORD", "user"])
