...
_RegDetails = FlextModelsHandler.RegistrationDetails
...
class FlextRegistry(s[bool]):
    ...
    class Summary(m.Value):
        ...
        registered: list[_RegDetails] = Field(
            default_factory=lambda: list[_RegDetails](),
