...
class FlextLogger:
    ...
    def log_operation(self, operation: str, duration_ms: float, success: bool, **kwargs) -> None:
    ...
    def log_api_request(self, method: str, path: str, status_code: int,
                       duration_ms: float, user_id: Optional[str] = None, **kwargs) -> None:
    ...
    def log_pipeline_event(self, pipeline_id: str, event_type: str,
    ...
    def log_plugin_event(self, plugin_name: str, event_type: str,
...
class LoggingContextManager:
    ...
    def __init__(self, logger: FlextLogger, operation: str, **kwargs) -> None:
        self.logger = logger
...
def log_async_operation(operation: str, **kwargs):
...
def log_startup(component: str, version: str, **kwargs) -> None:
...
def log_shutdown(component: str, **kwargs) -> None:
...
def log_security_event(event_type: str, severity: str, user_id: Optional[str] = None, **kwargs) -> None:
