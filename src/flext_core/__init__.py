...
if TYPE_CHECKING:
    ...
    from .__version__ import FlextVersion
...
__all__: tuple[str, ...] = (
    "FlextApi", "FlextBase", "FlextCli", "FlextConfig",
    ...
    "FlextLazy", "FlextLazyAttribute", "FlextMixins", "FlextModels",
    "FlextProtocols", "FlextRegistry", "FlextResult", "FlextRuntime",
    "FlextService", "FlextSettings", "FlextTypes", "FlextUtilities",
    "FlextUtilitiesLogging", "FlextUtilitiesRuntimeViolationRegistry", "FlextVersion", "__author__",
    "__author_email__", "__description__", "__license__", "__title__",
    "__url__", "__version__", "__version_info__", "c",
    "config", "core", "d", "e",
    "h", "lazy_attribute", "m", "p",
...
_LAZY_IMPORTS = MappingProxyType(
    build_lazy_import_map(
        MappingProxyType({
            ...
            ".utilities": (
                "FlextUtilities", "FlextUtilitiesRuntimeViolationRegistry", "u",
            ),
        }),
