...
from flext_core.events.event_bus import PipelineCreated, PipelineUpdated
...
class EventStore(DomainBaseModel):
    ...
    redis: Redis = Field(  # type: ignore[type-arg]
...
# ZERO TOLERANCE CONSOLIDATION: PipelineCreated/PipelineUpdated moved to flext_core.events.event_bus
# Use: from flext_core.events.event_bus import PipelineCreated, PipelineUpdated
...
def create_event_system(redis: Redis) -> tuple[EventStore, EventHandlerRegistry]:  # type: ignore[type-arg]
