# FLEXT CORE EVENTS - ENTERPRISE EVENT-DRIVEN ARCHITECTURE
...
The FLEXT Core Events module provides **enterprise-grade event-driven architecture** with comprehensive messaging and event sourcing:
...
├── 🔄 reflection.py          # Reflection-based events (568 lines) - CORE
...
### 🔄 **reflection.py** - Reflection-Based Events (568 lines)
...
from flext_core.events.event_bus import HybridEventBus, DomainEventBus, EventBus
...
PYTHONPATH=src python -c "
from flext_core.events.reflection import ReflectionEvent, EventStore, Projection
...
PYTHONPATH=src python -c "
from flext_core.events.event_bus import DomainEvent, PipelineCreated, PipelineUpdated
