...
Copyright (c) 2024 FLEXT Team. All rights reserved.
...
from flext_core.contracts.lifecycle_protocols import ResultProtocol
from flext_core.domain.advanced_types import RequestData, ServiceError, ServiceResult
