# FLEXT CORE APPLICATION - ENTERPRISE COMMAND & SERVICE LAYER
...
The FLEXT Core Application module serves as the **enterprise application services layer** implementing sophisticated CQRS patterns:
...
│   ├── FlextEnterpriseApplication     # Unified app with dual DI
...
```python
class FlextEnterpriseApplication:
...
PYTHONPATH=src python -c "
from flext_core.application.handlers import EnterpriseCommandHandlers
...
PYTHONPATH=src python -c "
from flext_core.application.container import ApplicationContainer
