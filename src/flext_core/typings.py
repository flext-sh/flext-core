...
Serves as single source of truth for all type definitions.
...
class FlextTypes:
    ...
    class Core:
        """Core fundamental types used throughout ecosystem."""
        ...
        type List = AnyList  # Backward compatibility
    ...
    class Validation:
        ...
        type ValidationPipeline = list[CustomValidator]  # Chain of validators
    ...
    class Config:
        ...
        type ConfigPath = str  # File path for configuration files
...
TServiceKey = FlextTypes.Service.ServiceKey
