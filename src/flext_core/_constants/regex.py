...
class FlextConstantsRegex:
    ...
    PATTERN_ENFORCE_RULE_ID: ClassVar[str] = r"^ENFORCE-\d{3}$"
    "Pattern for canonical enforcement rule identifiers."
    PATTERN_SEMVER: ClassVar[str] = (
        r"^\d+\.\d+\.\d+"
