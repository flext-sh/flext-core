...
class FlextConstantsBase:
    ...
    TIMEOUT: Final[int] = DEFAULT_TIMEOUT
    PAGE_SIZE: Final[int] = 100
    TIMEOUT_SECONDS: Final[int] = DEFAULT_TIMEOUT
    ...
    OPERATION_TIMEOUT_SECONDS: Final[int] = DEFAULT_TIMEOUT
    DATABASE_URL: Final[str] = "sqlite:///:memory:"
    DEFAULT_DATABASE_URL: Final[str] = DATABASE_URL

    DEFAULT_TIMEOUT_SECONDS: Final[int] = DEFAULT_TIMEOUT
    ...
    DEFAULT_POOL_SIZE: Final[int] = DEFAULT_CONNECTION_POOL_SIZE
    MAX_POOL_SIZE: Final[int] = MAX_CONNECTION_POOL_SIZE
    MIN_POOL_SIZE: Final[int] = 1
    MAX_NAME_LENGTH: Final[int] = 100
    MAX_OPERATION_NAME_LENGTH: Final[int] = 100
    MAX_PORT_NUMBER: Final[int] = MAX_PORT
    MIN_PORT_NUMBER: Final[int] = MIN_PORT
