...
class HostAddress(BaseModel):
    ...
    def validate_host_format(cls, v: str) -> str:
        ...
        if not re.match(r"^[a-zA-Z0-9\\\\1\\\1_]+$", v):
...
class ConnectionString(BaseModel):
    ...
    def validate_connection_string(cls, v: str) -> str:
        ...
        if re.search(r"password=\\\1+", v, re.IGNORECASE):
...
class EmailAddress(BaseModel):
    ...
    def validate_email_format(cls, v: str) -> str:
        ...
        email_pattern = r"^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\\\\1[a-zA-Z]{2,}$"
...
class Username(BaseModel):
    ...
    def validate_username(cls, v: str) -> str:
        ...
        reserved = {
            ...
            "REDACTED_LDAP_BIND_PASSWORDistrator",
            "root",
            "system",
            "user",
            "guest",
    ...
    def is_REDACTED_LDAP_BIND_PASSWORD(self) -> bool:
        """Check if username appears to be an REDACTED_LDAP_BIND_PASSWORD account."""
        REDACTED_LDAP_BIND_PASSWORD_patterns = ["REDACTED_LDAP_BIND_PASSWORD", "REDACTED_LDAP_BIND_PASSWORDistrator", "root", "superuser"]
        return any(pattern in self.value.lower() for pattern in REDACTED_LDAP_BIND_PASSWORD_patterns)
