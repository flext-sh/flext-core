...
class GithubPrExecutionResultModel(FlextModels.ArbitraryTypesModel):
    ...
    log_path: Annotated[str | None, Field(default=None, description="Log file path")]
...
class FlextInfraGithubModels:
    ...
    class WorkflowLintResult(FlextModels.ArbitraryTypesModel):
        ...
        reason: Annotated[str | None, Field(default=None, description="Skip reason")]
        detail: Annotated[str | None, Field(default=None, description="Failure detail")]
        exit_code: Annotated[
