...
class CoverageFailUnderConfig(FlextModels.ArbitraryTypesModel):
    ...
    model_config = ConfigDict(extra="forbid")
    core: Annotated[
        int, Field(description="Minimum coverage percentage required for core layer.")
    ]
    domain: Annotated[
        int, Field(description="Minimum coverage percentage required for domain layer.")
    ]
    platform: Annotated[
        int,
        Field(description="Minimum coverage percentage required for platform layer."),
    ]
    ...
    app: Annotated[
        int, Field(description="Minimum coverage percentage required for app layer.")
    ]
...
class WorkspaceDependencyReport(FlextModels.ArbitraryTypesModel):
    ...
    workspace: str
    projects: Annotated[dict[str, ProjectRuntimeReport], Field(default_factory=dict)]
