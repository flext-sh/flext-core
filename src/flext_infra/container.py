...
def configure_flext_infra_dependencies() -> None:
    ...
    _ = container.register(
        "command_runner",
        lambda: FlextInfraCommandRunner(),
        kind="factory",
    )
    _ = container.register(
        "discovery",
        lambda: FlextInfraDiscoveryService(),
        kind="factory",
    )
    _ = container.register(
        "selection",
        lambda: FlextInfraProjectSelector(),
        kind="factory",
    )
    _ = container.register(
        "reporting",
        lambda: FlextInfraReportingService(),
        kind="factory",
    )
    _ = container.register(
        "versioning",
    ...
    _ = container.register("output", lambda: output, kind="factory")
    _ = container.register(
        "basemk_engine",
    ...
    _ = container.register(
        "basemk_generator",
        lambda: FlextInfraBaseMkGenerator(),
        kind="factory",
    )
    _ = container.register(
        "workspace_detector",
        lambda: FlextInfraWorkspaceDetector(),
        kind="factory",
    )
    _ = container.register(
        "workspace_migrator",
        lambda: FlextInfraProjectMigrator(),
        kind="factory",
    )
    _ = container.register(
    ...
    _ = container.register(
        "workspace_sync",
        lambda: FlextInfraSyncService(),
        kind="factory",
    )
    _ = container.register(
        "release_orchestrator",
        lambda: FlextInfraReleaseOrchestrator(),
        kind="factory",
    )
    _ = container.register(
