...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "BLUE": ("flext_infra.output", "BLUE"),
    "BOLD": ("flext_infra.output", "BOLD"),
    ...
    "GREEN": ("flext_infra.output", "GREEN"),
    ...
    "NamespaceEnforcementModels": ("flext_infra.refactor.namespace_enforcer", "NamespaceEnforcementModels"),
    ...
    "RED": ("flext_infra.output", "RED"),
    "RESET": ("flext_infra.output", "RESET"),
    "RuntimeAliasDetector": ("flext_infra.refactor.dependency_analyzer", "RuntimeAliasDetector"),
    "SYM_ARROW": ("flext_infra.output", "SYM_ARROW"),
    "SYM_BULLET": ("flext_infra.output", "SYM_BULLET"),
    "SYM_FAIL": ("flext_infra.output", "SYM_FAIL"),
    "SYM_OK": ("flext_infra.output", "SYM_OK"),
    "SYM_SKIP": ("flext_infra.output", "SYM_SKIP"),
    "SYM_WARN": ("flext_infra.output", "SYM_WARN"),
    "SyncOperation": ("flext_infra.github.workflows", "SyncOperation"),
    "WorkspaceMode": ("flext_infra.workspace.detector", "WorkspaceMode"),
    "YELLOW": ("flext_infra.output", "YELLOW"),
    ...
    "configure_flext_infra_dependencies": ("flext_infra.container", "configure_flext_infra_dependencies"),
    ...
    "load_python_module": ("flext_infra.refactor.dependency_analyzer", "load_python_module"),
    ...
    "render_namespace_enforcement_report": ("flext_infra.refactor.output", "render_namespace_enforcement_report"),
