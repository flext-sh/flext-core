...
help: ## Show this help message
	@echo "FLEXT-CORE Development Commands"
	@echo "===================================="
	@grep -E '^[a-zA-Z_-]+:.*?## .*$$' $(MAKEFILE_LIST) | sort | awk 'BEGIN {FS = ":.*?## "}; {printf "\033[36m%-20s\033[0m %s\n", $$1, $$2}'

# Installation
install: ## Install dependencies
	@echo "📦 Installing dependencies for flext-core..."
...
# Code quality
lint: ## Run linters
	@echo "🔍 Running linters for flext-core..."
	@python -m ruff check .
	@python -m mypy src/ || true

format: ## Format code
	@echo "🎨 Formatting code for flext-core..."
	@python -m black .
	@python -m ruff check --fix .

check: lint test ## Run all quality checks
	@echo "✅ All quality checks complete for flext-core!"

# Build
build: ## Build the package
	@echo "🔨 Building flext-core..."
	@if [ -f pyproject.toml ]; then \
		poetry build; \
	else \
...
dev-setup: install ## Complete development setup
	@echo "🎯 Setting up development environment for flext-core..."
